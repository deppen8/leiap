...
def get_balearic(lang="both"):
    ...
    """
    p = {
        "Punic Ebusitan amphora": "Àmfora Punicoebusitana",
...
def get_early_roman(lang="both"):
    ...
    """
    p = {
        "Tarraconense amphora": "Àmfora Tarraconense",
...
def get_late_roman(lang="both"):
    ...
    """
    p = {
        "Late Roman amphorae (LRA)": "Late Roman amphorae (LRA)",
...
def get_islamic(lang="both"):
    ...
    """
    p = {
        "Islamic medieval common ware": "Ceràmica Comuna Medieval Islàmica",
